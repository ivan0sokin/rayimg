...
fn main() {
    ...
    let lime_outer_glass_sphere = Sphere::new(Vec3::new(1.0, 0.0, -1.0), 0.5, Dielectric::new(RGB(0.05, 0.95, 0.05), 1.5));
    let lime_inner_glass_sphere = Sphere::new(Vec3::new(1.0, 0.0, -1.0), -0.45, Dielectric::new(RGB(0.05, 0.95, 0.05), 1.5));
    ...
    renderer.render_multithreaded(P3ImageWriter::new((1280, 720), std::fs::File::create("examples/output/dielectric/dielectric.ppm").expect("Failed to create output file")));
}
