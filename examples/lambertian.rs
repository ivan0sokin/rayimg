...
fn main() {
    ...
    let yellow_sphere = Sphere::new(Vec3::new(-1.0, 0.0, -1.0), 0.5, Lambertian::new(RGB(1.0, 1.0, 0.0)));
    let grey_sphere = Sphere::new(Vec3::new(1.0, 0.0, -1.0), 0.5, Lambertian::new(RGB(0.769, 0.792, 0.808)));
